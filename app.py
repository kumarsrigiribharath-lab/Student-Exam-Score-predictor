...
with col1:
    ...
    hours = st.number_input("Hours Studied", min_value=0, max_value=24, value=0,help="e.g. 5")
    attendance = st.number_input("Attendance (%)", min_value=0, max_value=100, value=0,help="e.g. 80")
